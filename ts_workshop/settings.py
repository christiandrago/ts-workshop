"""
Django settings for ts_workshop project.
...
SECRET_KEY = ')n-39g$uigrtsxlp%_-_96iz_nopo2#eawd!d42%k43!y5j$k-'
...
WSGI_APPLICATION = 'ts_workshop.wsgi.application'
